...
namespace OpenAI_API
{
	...
	public abstract class EndpointBase
	{
		...
		/// <summary>
		/// The name of the endpoint, which is the final path segment in the API URL. Must be overridden in a derived class.
		/// </summary>
		protected abstract string Endpoint { get; }

		/// <summary>
		/// Gets the URL of the endpoint, based on the base OpenAI API URL followed by the endpoint name.
		/// </summary>
		...
		protected HttpClient GetClient()
		{
			...
			{
				throw new AuthenticationException("You must provide API authentication. Please refer to the OpenAI API documentation for details.");
			}
